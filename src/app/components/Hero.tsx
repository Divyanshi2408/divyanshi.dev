...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0F172A] text-[#F1F5F9]">
      ...
      {/* Navigation */}
      <nav className="flex justify-center gap-6 md:gap-10 py-4 font-semibold text-sm md:text-base text-[#F1F5F9]">
      ...
      <section className="flex flex-col md:flex-row justify-center items-stretch gap-10 md:gap-20 px-6 md:px-20 py-16">
        {/* Left Text */}
        <div
          className="flex-1 flex items-center justify-center md:justify-end animate-fade-in"
        >
          <div className="text-center md:text-left max-w-sm transition-opacity duration-1000 delay-200">
            <h2 className="text-6xl font-bold leading-tight mb-2 text-[#F1F5F9]">
              Divyanshi<br /> Pal
            </h2>
        ...
        <div className="flex-1 flex items-center justify-center animate-scale-in">
          <div className="w-[180px] md:w-[200px] lg:w-[340px] shadow-lg transition-transform duration-500 hover:scale-105">
            <img

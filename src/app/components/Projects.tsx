...
//   return (
//     <section ref={sectionRef} className="bg-[#0F172A] text-[#fad4da] px-4 md:px-20 py-16">
//       <h2 className="text-3xl md:text-4xl font-bold text-center mb-2">Featured Projects</h2>
//       <p className="text-center text-gray-400 mb-10 text-sm md:text-base">
//         Explore my latest work and creative solutions
//       </p>
...
//       <div className="flex flex-col lg:flex-row gap-10">
//         {/* Featured Project Card */}
//         <div ref={cardRef} className="lg:w-[65%] w-full bg-[#fad4da] rounded-2xl p-6 sm:p-8 shadow-lg flex flex-col justify-between">
//           <div className="relative">
//             <Image
//               src={selectedProject.image}
//               alt={`Screenshot of ${selectedProject.title}`}

 ...
 useEffect(() => {
  ...
  return (
      ...
      <div className="about-card bg-[#fad4da] rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow flex flex-col justify-between">
        ...
        <a
          href="#contact"
          className="mt-6 inline-flex items-center gap-2 text-[#e55a6d] font-medium border border-[#e55a6d] rounded-lg px-4 py-2 hover:bg-[#e55a6d] hover:text-white transition"
        >
